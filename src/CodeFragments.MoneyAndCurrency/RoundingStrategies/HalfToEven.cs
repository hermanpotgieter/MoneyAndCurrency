...
{
    /// <summary>
    /// Rounding a fraction part of 0.5 results in the nearest EVEN integer.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    internal class HalfToEven : RoundingStrategy
    {
        protected internal override decimal CalculateRoundedAmount(decimal value)
        {
            ...
            // and the result of rounding is odd, subtract 1.  
